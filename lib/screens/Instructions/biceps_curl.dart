...
class BicepsCurl extends StatefulWidget {
  const BicepsCurl({super.key});

  @override
  State<BicepsCurl> createState() => _BicepsCurlState();
}

class _BicepsCurlState extends State<BicepsCurl> {
